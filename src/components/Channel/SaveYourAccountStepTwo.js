...
import SaveYourAccountStepThree from './SaveYourAccountStepThree';

class SaveYourAccountStepTwo extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
          name: '',
    ...
    isFormValid(name, url) {
      return /^\w+$/.test(url) && name.length > 0;
    }
          ...
          <div className='modal-overlay'>
            <div className='modal-content'>
              <div>
                ...
                <div className='onboarding-step-fields-container'>
                  <p>devchat URL</p>
                  <input onChange={this.update('url')} type='text' value={`${url}`}/>
...
export default SaveYourAccountStepTwo;
